    ...
    return (
        <div className={styles.Wrapper}>
            ...
            <div className={styles.ResultBlock}>
                ...
                <p className={styles.BlockDescription}>
                    – Выстроил процесс внутри дизайн-команды; <br/>
                    – Генерил и валидировал гипотезы; <br/>
                    – Собрал дизайн-систему; <br/>
                    – Описал правила работы с макетами и передачу в разработку; <br/>
